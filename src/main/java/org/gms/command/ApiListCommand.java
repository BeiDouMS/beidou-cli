...
public class ApiListCommand implements Callable<Integer> {
    ...
    private static final List<ApiEntry> APIS = List.of(
            ...
            e("POST", "/account/v1",                         "注册账号，body: {\"name\":\"...\", \"password\":\"...\"}", true),
            ...
            e("POST", "/character/v1/online/list",       "在线角色列表 (分页)，body: {\"pageNum\":1, \"pageSize\":10}", false),

            // === Common ===
            e("POST", "/common/v1/getEquipmentInfoByItemId",       "根据道具 ID 查装备信息，body: {\"itemId\":...}", false),
            e("POST", "/common/v1/getAllWorldsOnlinePlayersCount", "查询各世界在线人数，body: {\"worldIdList\":[1,2]}", false),
            e("POST", "/common/v1/informationSearch",              "搜索账号/角色，body: {\"keyword\":\"...\"}", false),

            // === CashShop ===
            e("GET",  "/cashShop/v1/getAllCategoryList",   "商城分类列表", false),
            e("POST", "/cashShop/v1/getCommodityByCategory","按分类查商品 (分页)，body: {\"category\":..., \"pageNum\":1, \"pageSize\":10}", false),
            ...
            e("POST", "/cashShop/v1/batchOnSale",          "批量上架，body: {\"snList\":[...]}", true),

            // === Drop ===
            e("POST",   "/drop/v1/getDropList",           "怪物掉落列表 (分页)，body: {\"pageNum\":1, \"pageSize\":10}", false),
            e("POST",   "/drop/v1/getGlobalDropList",     "全局掉落列表 (分页)", false),
            e("PUT",    "/drop/v1/addDropData",           "添加怪物掉落，body: {\"dropId\":..., \"itemId\":..., ...}", true),
            e("PUT",    "/drop/v1/addGlobalDropData",     "添加全局掉落", true),
            e("POST",   "/drop/v1/updateDropData",        "更新怪物掉落", true),
            e("POST",   "/drop/v1/updateGlobalDropData",  "更新全局掉落", true),
            e("DELETE", "/drop/v1/deleteDropData/{id}",   "删除怪物掉落", true),
            e("DELETE", "/drop/v1/deleteGlobalDropData/{id}","删除全局掉落", true),

            // === Gachapon ===
            e("POST", "/gachapon/v1/getPools",     "扭蛋奖池列表，body: {\"pageNum\":1, \"pageSize\":10}", false),
            ...
            // === Give ===
            e("POST", "/give/v1/resource", "发放资源给玩家，body: {\"characterId\":..., \"itemId\":..., \"quantity\":...}", true),

            // === Inventory ===
            e("GET",  "/inventory/v1/getInventoryTypeList", "背包分类列表", false),
            e("POST", "/inventory/v1/getCharacterList",     "按条件搜索角色，body: {\"characterName\":\"...\"}", false),
            e("POST", "/inventory/v1/getInventoryList",     "查角色背包道具，body: {\"characterId\":..., \"inventoryType\":...}", false),
            e("POST", "/inventory/v1/updateInventory",      "修改背包道具，body: {\"id\":..., \"quantity\":...}", true),
            e("POST", "/inventory/v1/deleteInventory",      "删除背包道具", true),

            // === Shop ===
            e("POST",   "/shop/v1/getShopList",           "商店列表 (分页)，body: {\"pageNum\":1, \"pageSize\":10}", false),
            e("POST",   "/shop/v1/getShopItemList",       "商店道具列表，body: {\"shopId\":...}", false),
            e("GET",    "/shop/v1/getShopItem/{id}",      "按 ID 查道具", false),
            e("PUT",    "/shop/v1/addShopItem",           "添加商店道具，body: {\"shopId\":..., \"itemId\":..., \"price\":...}", true),
            e("POST",   "/shop/v1/updateShopItem",        "更新商店道具", true),
            e("DELETE", "/shop/v1/deleteShopItem/{id}",   "删除商店道具", true),

            // === Config ===
            e("GET",    "/config/v1/getConfigTypeList",   "配置分类列表", false),
            e("POST",   "/config/v1/getConfigList",       "配置列表 (分页)，body: {\"configType\":..., \"pageNum\":1, \"pageSize\":10}", false),
            e("POST",   "/config/v1/addConfig",           "添加配置，body: {\"configType\":..., \"key\":\"...\", \"value\":\"...\"}", true),
            ...
            // === Command ===
            e("POST", "/command/v1/getCommandListFromDB",    "GM 命令列表 (分页)，body: {\"pageNum\":1, \"pageSize\":10}", false),
